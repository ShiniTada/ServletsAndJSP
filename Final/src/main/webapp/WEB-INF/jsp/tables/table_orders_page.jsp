    ...
    <div>
        ...
        <div style="margin-left:20%; margin-right:15%;">
            <div class="w3-container w3-center">
                <h2 class="title w3-text-black" style="margin-top:100px;">${orders}</h2>
                <table class="w3-table-all">
                    ...
                    <tr class="w3-teal">
                        ...
                        <th>${Status}</th>
                            ...
                            <c:forEach var="elem" items="${sessionScope.listOrders}">
                ...
                <div class="pagination">
                    <my:paginator limit="${sessionScope.limitCount}" total="${sessionScope.totalCount}" command="get-all-orders"/>
                </div>
            </div>
