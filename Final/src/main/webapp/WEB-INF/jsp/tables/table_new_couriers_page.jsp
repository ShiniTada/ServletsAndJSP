    ...
    <div class="w3-sidebar w3-light-grey w3-bar-block" style="width:15%">
        ...
        <div class="sign-in">
            <form action="Controller" method="get">
                ...
                <button class="w3-button w3-bar-item w3-padding-large btn-lg  w3-teal btn-block " type="submit">${courier_applications}</button>
            </form>
        </div>
    ...
    <div style="margin-left:20%; margin-right:15%;">
        <div class="w3-container w3-center">
            ...
            <c:choose>
                ...
                <c:when test="${sessionScope.listNewCourierRecords.size() == 0}">
                    <h3>${empty_new_table_message}</h3>
                </c:when>
                <c:otherwise>
                    <table class="w3-table-all">
                        ...
                        <tr class="w3-teal">
                            ...
                            <td>${more_details}</td>
                                ...
                                <c:forEach var="elem" items="${sessionScope.listNewCourierRecords}">
                                    <tr>
