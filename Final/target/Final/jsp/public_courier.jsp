            ...
            <c:choose>
                <c:when test="${sessionScope.user.role.getValue() eq 'admin'}">
                    <c:choose>
                        ...
                        <c:when test="${sessionScope.courierRecord.status eq 1}">
                        <div class="w3-cell w3-container" style="width:20%;">
                            </c:when>
                    </c:choose>
                </c:when>
                <c:otherwise>
        ...
        <div class="w3-twothird ">
            ...
            <div class="w3-container w3-margin-bottom">
                <form action="Controller" method="post">
                    ...
                    <button class="w3-block w3-round w3-center w3-teal w3-button w3-cell w3-right"
