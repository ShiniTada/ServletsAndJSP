...
<head>
    ...
    <fmt:message bundle="${loc}" key="local.customer.evaluate_info" var="evaluate_info"/>
                            ...
                            <tr class="w3-hover-light-blue">
                                ...
                                <c:choose>
                                    <c:when test="${elem.status.getValue() eq 'posted'}">
                                        ...
                                        <td>
                                                <button class="w3-block w3-round  w3-disabled w3-center w3-khaki w3-button"
                                                        style="max-width:150px">${evaluate}</button>
                                        </td>
                                    </c:when>
                                    <c:when test="${elem.status.getValue() eq 'delivered'}">
                                        ...
                                        <td>
                                         ...
                                         w3-button" onclick="document.getElementById('id01').style.display='block'" name="courierLogin" value="${elem.courier.login}"  style="max-width:150px">${evaluate}</button>
                                                <div id="id01" class="w3-modal">
                                                    <div class="w3-modal-content" style="max-width:350px">
                                                        <header class="w3-container w3-teal"> <span onclick="document.getElementById('id01').style.display='none'"
